...
public class PlanSearch extends BaseActivity implements MyXListViewListener {
		...
		new Thread(){
			...
			public void run() {
				...
				if (result != null) {
					...
					Toast.makeText(PlanSearch.this, "没有更多数据！", Toast.LENGTH_SHORT).show();
				}
			}
		}.start();
	}
