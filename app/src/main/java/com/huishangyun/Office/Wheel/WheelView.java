...
package com.huishangyun.Office.Wheel;
...
public class WheelView extends View {
	/** Scrolling duration  滚动的时间*/
	private static final int SCROLLING_DURATION = 400;

	/** Minimum delta for scrolling 滚动的最小的增量*/
	private static final int MIN_DELTA_FOR_SCROLLING = 1;

	/** Current value & label text color 当前值或标签文字的颜色*/
	...
	private static final int[] SHADOWS_COLORS = new int[] { 0x0021a5de,
			0x0021a5de, 0x0021a5de };

	/** Additional items height (is added to standard text item height) */
	private static int ADDITIONAL_ITEM_HEIGHT = 15;
	...
	/** Default count of visible items 一列显示五个数字*/
     ...
     */
	public void setData (){
   	 int  screenWidth = MainAttendanceActivity.W;
   	 int  screenHeigh = MainAttendanceActivity.H;
   	 int width = screenHeigh>=screenWidth?screenHeigh:screenWidth;
   	TEXT_SIZE = (width/134)*4;
   	ITEM_OFFSET = TEXT_SIZE / 5;
   	ADDITIONAL_ITEM_HEIGHT = (width/134)*3;
   	ADDITIONAL_ITEMS_SPACE = (width/134)*2;
   	PADDING = (width/134)*2;
   	value_TEXT_SIZE = (width/134)*5;
	}
	...
	private void initResourcesIfNecessary() {
		...
		if (centerDrawable == null) {
			centerDrawable = getContext().getResources().getDrawable(R.drawable.office_wheel_val);
		}
		...
		setBackgroundResource(R.drawable.office_wheel_bg);
	}
