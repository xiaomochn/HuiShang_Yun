...
public class FragmentForDetail extends Fragment implements MyXListView.MyXListViewListener {
	...
	private void init() {
		...
		intentFilter.addAction("AskForLeave_DETAIL");
		intentFilter.setPriority(Integer.MAX_VALUE);
		getActivity().registerReceiver(broadcastReceiver, intentFilter);
		
		askforleavelistview = (MyXListView) View.findViewById(R.id.askforleavelistview);
	...
	private BroadcastReceiver broadcastReceiver = new BroadcastReceiver() {
		public void onReceive(Context context, Intent intent) {
			...
			getNetData(Company_ID, Manager_ID, 0, PageIndex, 5, 1);
		}
			...
			String time = sf.format(date1);
			 ViewHolder holder; 
				if (convertView == null) {
					...
					holder.datelayout = (RelativeLayout) convertView.findViewById(R.id.datelayout);
...
//				}
	...
	public void onLoadMore() {
        ...
        PageIndex += 1;
        getNetData(Company_ID, Manager_ID, 0, PageIndex, 5, 2);
	}
