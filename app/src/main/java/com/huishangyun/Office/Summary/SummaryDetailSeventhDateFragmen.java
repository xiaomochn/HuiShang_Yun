...
public class SummaryDetailSeventhDateFragmen extends Fragment implements MyXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (SeventhView == null) {
            SeventhView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment, container, false);
    ...
    public void onDestroyView() {
        ...
        super.onDestroyView();
        if (null != SeventhView) {
            ((ViewGroup) SeventhView.getParent()).removeView(SeventhView);
        }
    }
     ...
     */
    private void init() {
        no_information = (ImageView) SeventhView.findViewById(R.id.no_information);
        slistview = (MyXListView) SeventhView.findViewById(R.id.businesstriplistview);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.person_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAGS","getOFUserName7="+list.get(position).getOFUserName());
                    Log.e("TAGS","getManager_Name7="+list.get(position).getManager_Name());
                }
            });
            return convertView;
        }
