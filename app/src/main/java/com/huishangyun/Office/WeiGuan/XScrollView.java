...
//    private static final String TAG = "XScrollView";
	...
	private OnScrollPostionListener onScrollPostion;
...
//                startLoadMore();
        ...
        try {
        	  onScrollPostion.OnScrollPostionListener(t);
		} catch (Exception e) {
    ...
    public void setOnScrollPostionLintener(OnScrollPostionListener listener){
		 onScrollPostion = listener;
	}
	
	public interface OnScrollPostionListener{
