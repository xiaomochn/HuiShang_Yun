...
public class MainAskForLeaveOrdinaryEntryActivity extends BaseActivity {
	...
	private class ButtonClickListener implements View.OnClickListener{
		...
		public void onClick(View v) {
			...
			case R.id.back://返回
				...
				break;
			case R.id.add://新增请假
				Intent intent = new Intent(MainAskForLeaveOrdinaryEntryActivity.this,AddAskForLeaveActivivty.class);
				startActivity(intent);
				break;
            case R.id.allaskforleave://全部请假
            	mPager.setCurrentItem(0);
            	allaskforleave.setTextColor(Color.parseColor("#21a5de"));
			...
			case R.id.myaskforleave://我的请假
            	...
            	myaskforleave.setTextColor(Color.parseColor("#21a5de"));
            	departmentaskforleave.setTextColor(Color.parseColor("#646464"));
				break;
			case R.id.departmentaskforleave://部门请假
				...
				allaskforleave.setTextColor(Color.parseColor("#646464"));
            	myaskforleave.setTextColor(Color.parseColor("#646464"));
            	departmentaskforleave.setTextColor(Color.parseColor("#21a5de"));
				break;
