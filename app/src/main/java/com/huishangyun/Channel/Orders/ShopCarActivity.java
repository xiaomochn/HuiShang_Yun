...
//	private SQLiteDatabase db;
	...
	private LinearLayout back, content;
...
//		db = mySql.getWritableDatabase();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ShopCarActivity.this, DatailsActivity.class);					
				//把点击产品的id传给产品详情页。
		...
		data2 = CartManager.getInstance(ShopCarActivity.this).getCartModels();
	...
	private void init(){
		...
		submit.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				if (data.size() > 0) {
					Intent intent = new Intent(ShopCarActivity.this, DingDanActivity.class);
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(final int position, View view, ViewGroup parent) {
			...
			new ImageLoader(ShopCarActivity.this).DisplayImage(
			...
			holder.add.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					//更改
					for (int i = 0; i < data.size(); i++) {								
						CartManager.getInstance(ShopCarActivity.this).saveCarts(data.get(i));
					}
				}
			});
			...
			holder.img2.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					AlertDialog.Builder builder = new Builder(ShopCarActivity.this);
					...
					builder.setPositiveButton("确认", new DialogInterface.OnClickListener() {
						...
						for (int j = 0; j < id_list.size(); j++) {
							CartManager.getInstance(ShopCarActivity.this).deleteCart(id_list.get(j));
						}
			...
			holder.edt.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					LayoutInflater layoutInflater = LayoutInflater.from(ShopCarActivity.this);
					View view = layoutInflater.inflate(R.layout.alertdialog_goodsnub, null);
					final AlertDialog dialog = new AlertDialog.Builder(ShopCarActivity.this).create();
					...
					confirm.setOnClickListener(new OnClickListener() {
						public void onClick(View v) {
							...
							if (!edt.getText().toString().equals("") && 
								...
								CartManager.getInstance(ShopCarActivity.this).saveCarts(cartModel);
								//更改数据库后再查一遍再计算总价  
								//query ();
								initCount();
...
//				
//				L.e("_id:" + cursor.getInt(0));
//				L.e("id:" + cursor.getInt(1));
//				L.e("name：" + cursor.getString(3));
//				L.e("prices：" + cursor.getDouble(4));
//				L.e("unit：" + cursor.getString(5));
