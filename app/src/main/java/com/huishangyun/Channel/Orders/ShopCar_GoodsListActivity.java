...
//		db = mySql.getWritableDatabase();
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(ShopCar_GoodsListActivity.this, DatailsActivity.class);					
				//把点击产品的id传给产品详情页。
		...
		data2 = CartManager.getInstance(ShopCar_GoodsListActivity.this).getCartModels();
			...
			public void onClick(View v) {
				...
				if (data.size() > 0) {//清单不能全删除
					...
					for (int i = 0; i < data.size(); i++) {								
						CartManager.getInstance(ShopCar_GoodsListActivity.this).saveCarts(data.get(i));
					}
					//删除数据库的这条数据。
					for (int j = 0; j < id_list.size(); j++) {
						CartManager.getInstance(ShopCar_GoodsListActivity.this).deleteCart(id_list.get(j));
					}
					...
					if (getIntent().getStringExtra("flage") != null) {																		
						...
						Intent intent = new Intent(ShopCar_GoodsListActivity.this, DingDanActivity.class);
	...
	private class MyAdapter extends BaseAdapter{
		...
		public View getView(final int position, View view, ViewGroup parent) {
			...
			new ImageLoader(ShopCar_GoodsListActivity.this).DisplayImage(
			...
			holder.img2.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					AlertDialog.Builder builder = new Builder(ShopCar_GoodsListActivity.this);
			...
			holder.edt.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					LayoutInflater layoutInflater = LayoutInflater.from(ShopCar_GoodsListActivity.this);
					View view = layoutInflater.inflate(R.layout.alertdialog_goodsnub, null);
					final AlertDialog dialog = new AlertDialog.Builder(ShopCar_GoodsListActivity.this).create();
