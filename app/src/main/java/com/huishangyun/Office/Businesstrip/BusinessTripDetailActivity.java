...
public class BusinessTripDetailActivity extends BaseActivity {
	...
	public int Manager_ID;//详情人id
	public int Department_ID;//部门id
	public int managerid;//登入人id
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		getIntent().putExtra("managerid", managerid);
		getNetData();
	...
	private void init(){
		...
		addaskforleave.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(BusinessTripDetailActivity.this,AddBusinessTrip.class);
		...
		new Thread(){
			...
			public void run() {
				...
				String result = DataUtil.callWebService(
						Methods.GET_BUSINESSTRIP_MANGAGER_LIST,
						getJson());	
	...
	public void showDialog(String TXT){
		new ClueCustomToast().showToast(BusinessTripDetailActivity.this,
	...
	public void InitViewPager(){
		...
		for (int i = 0; i < list.size(); i++) {
			fragment1 = new BusinessTripDetailFragment();
