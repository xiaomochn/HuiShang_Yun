...
public class SummaryDetailFistDateFragment extends Fragment implements MyXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (fistView == null) {
            fistView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment, container, false);
    ...
    public void onDestroyView() {
        ...
        super.onDestroyView();
        if (null != fistView) {
            ((ViewGroup) fistView.getParent()).removeView(fistView);
        }
    }
     ...
     */
    private void init() {
        no_information = (ImageView) fistView.findViewById(R.id.no_information);
        slistview = (MyXListView) fistView.findViewById(R.id.businesstriplistview);
...
//    private void UserNameJson(String str) {
//        try {
//            JSONObject objects = new JSONObject(str);
//            JSONArray array = objects.getJSONArray("Results");
//            for (int i = 0; i < array.length(); i++) {
//                JSONObject jsonObject = array.getJSONObject(i);
//                OFUserName = jsonObject.getString("OFUserName");
//            }
        ...
        new Thread() {
            ...
            public void run() {
                ...
                String result = DataUtil.callWebService(
                        ...
                        getJson(ID, BelongDate, Manager_ID, Department_ID, pageIndex, pageSize, index));
                  Log.e("TAGS", "result1:=" + result);
//                Log.e("TAGS", "result:=getjson" + getJson(ID, BelongDate, Manager_ID, Department_ID,
//                        pageIndex, pageSize, index));
               // UserNameJson(result);//解析数据
...
//			ImageLoad.displayImage(person_url, holder.person_img, R.drawable.person_img,10);
            ...
            holder.person_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAGS","getOFUserName1="+list.get(position).getOFUserName());
                    Log.e("TAGS","getManager_Name1="+list.get(position).getManager_Name());
                }
            });
            return convertView;
        }
    ...
    static class ViewHolder {
        ...
        private TextView exprenice;//问题反馈
