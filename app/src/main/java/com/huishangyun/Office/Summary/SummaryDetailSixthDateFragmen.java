...
public class SummaryDetailSixthDateFragmen extends Fragment implements MyXListView.MyXListViewListener {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		SixthView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment,container, false);
	...
	public void onDestroyView() {
	    ...
	    super .onDestroyView();
	    if (null != SixthView) {
	        ((ViewGroup) SixthView.getParent()).removeView(SixthView);
	    }
	}
	 ...
	 */
	private void init() {
		no_information = (ImageView) SixthView.findViewById(R.id.no_information);
		slistview = (MyXListView) SixthView.findViewById(R.id.businesstriplistview);
	...
	private void getNetData(final int ID, final String BelongDate,final int Manager_ID,
		...
		new Thread(){
			...
			public void run() {
				...
				Log.e("TAGS", "result哈6=:" + result);
				//Log.e("TAGS", "result哈2=:" + getJson(ID,BelongDate, Manager_ID, Department_ID,
						// pageIndex,pageSize,index));
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			holder.person_img.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View view) {
					...
					Log.e("TAGS","getOFUserName6="+list.get(position).getOFUserName());
					Log.e("TAGS","getManager_Name6="+list.get(position).getManager_Name());
				}
			});
			return convertView;
		}
