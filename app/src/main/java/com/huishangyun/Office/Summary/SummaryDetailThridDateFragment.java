...
public class SummaryDetailThridDateFragment extends Fragment implements MyXListView.MyXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (ThridView == null) {
            ThridView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment, container, false);
    ...
    public void onDestroyView() {
        ...
        super.onDestroyView();
        if (null != ThridView) {
            ((ViewGroup) ThridView.getParent()).removeView(ThridView);
        }
    }
     ...
     */
    private void init() {
        no_information = (ImageView) ThridView.findViewById(R.id.no_information);
        slistview = (MyXListView) ThridView.findViewById(R.id.businesstriplistview);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.person_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAGS","getOFUserName3="+list.get(position).getOFUserName());
                    Log.e("TAGS","getManager_Name3="+list.get(position).getManager_Name());
                }
            });
            return convertView;
        }
