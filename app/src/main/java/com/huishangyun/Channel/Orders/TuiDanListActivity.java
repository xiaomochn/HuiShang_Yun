...
public class TuiDanListActivity extends BaseActivity {
	...
	private void init(){
		...
		add.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(TuiDanListActivity.this, OrderMainActivity.class);	
		...
		find.setOnClickListener(new OnClickListener() {
			public void onClick(View v) {
				Intent intent = new Intent(TuiDanListActivity.this, FindActivity.class);	
				startActivity(intent);			
			}
		});
	...
	public void InitViewPager() {
		...
		Fragment_TuiDanAll fragment1 = new Fragment_TuiDanAll();
		Fragment_TuiDanMy fragment2 = new Fragment_TuiDanMy();
		Fragment_TuiDanBuMen fragment3 = new Fragment_TuiDanBuMen();
