...
public class SummaryDetailFifthDateFragment extends Fragment implements MyXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (FifthView == null) {
            FifthView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment, container, false);
    ...
    public void onDestroyView() {
        ...
        super.onDestroyView();
        if (null != FifthView) {
            ((ViewGroup) FifthView.getParent()).removeView(FifthView);
        }
    }
     ...
     */
    private void init() {
        no_information = (ImageView) FifthView.findViewById(R.id.no_information);
        slistview = (MyXListView) FifthView.findViewById(R.id.businesstriplistview);
...
//			ImageLoad.displayImage(person_url, holder.person_img, R.drawable.person_img,10);
            ...
            holder.person_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAGS","getOFUserName5="+list.get(position).getOFUserName());
                    Log.e("TAGS","getManager_Name5="+list.get(position).getManager_Name());
                }
            });
            return convertView;
        }
