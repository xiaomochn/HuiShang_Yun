...
public class SendCrashLog extends AsyncTask<String, String, Boolean>{
	private static final String url = "http://newws.huishangyun.com/MicroWeb/upload.aspx"; //异常信息上传接口
	private static SendCrashLog INSTANCE = new SendCrashLog();
	...
	public Boolean doInBackground(String... params) {
        ...
        try {
            ...
            String action = "--" + boundary + lineEnd + 
            		"Content-Disposition: form-data; name=\"action\"" + lineEnd +lineEnd +"android_error" +
            		lineEnd;
            // 向流中写入fileMeta  
