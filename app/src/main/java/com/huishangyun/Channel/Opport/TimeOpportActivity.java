...
public class TimeOpportActivity extends BaseActivity {
	...
	TimeListViewAdapter  adapter;//阶段listview适配器
	...
	public class ButtonClickListener implements View.OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.back://返回主界面
				finish();
				Intent intent = new Intent(TimeOpportActivity.this,MainOpportActivity.class);
				startActivity(intent);
				break;
//			case R.id.search_opport:
//				top_bar.setVisibility(View.GONE);
//                search_bar.setVisibility(View.VISIBLE); 
//                rl_canvers.setVisibility(View.VISIBLE); 
//                //让软键盘自动弹出
...
//				break;
			case R.id.create_opport:
				//跳转到创建商机页面
				Intent createintent = new Intent(TimeOpportActivity.this,
...
//                rl_canvers.setVisibility(View.GONE);                 
//                InputMethodManager inputManager1 = 
//		        (InputMethodManager)ed_text.getContext().getSystemService(Context.INPUT_METHOD_SERVICE); 
//		        inputManager1.hideSoftInputFromWindow(ed_text.getWindowToken(), 0); //强制隐藏键盘  
//		        
//				break;
...
//		        (InputMethodManager)ed_text.getContext().getSystemService(Context.INPUT_METHOD_SERVICE); 
//		        inputManager2.hideSoftInputFromWindow(ed_text.getWindowToken(), 0); //强制隐藏键盘  
//		        
//				break;				
			...
			case R.id.opport_pop_stage://本页面
				mWindow.dismiss();
				finish();
				Intent intent1 = new Intent(TimeOpportActivity.this,StageOpportActivity.class);
			...
			case R.id.opport_pop_time://跳转到时间页面
				mWindow.dismiss();
//				finish();
//				Intent intent1 = new Intent(TimeOpportActivity.this,TimeOpportActivity.class);
//				startActivity(intent1);
				break;
			...
			case R.id.opport_pop_priority://跳转到金额页面
				mWindow.dismiss();
				finish();
				Intent intent2 = new Intent(TimeOpportActivity.this,
	...
	private void viewpagerinit() {
		...
		mInflater = getLayoutInflater().from(TimeOpportActivity.this);
...
//		adapter1 = new AllListViewAdapter(this);
		adapter = new TimeListViewAdapter (this);
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				convertView = mInflater.inflate(
						R.layout.activity_opport_time_listview_item, null);// 根据布局文件实例化view
				
				holder = new ViewHolderStage();
				holder.item = (LinearLayout) convertView.findViewById(R.id.item);
				holder.time = (TextView) convertView.findViewById(R.id.time);// 找某个控件 --时间名称
				holder.year = (TextView) convertView.findViewById(R.id.year);
				holder.number = (TextView) convertView.findViewById(R.id.number);// 找某个控件--此时间数量				
				holder.time_img = (ImageView) convertView.findViewById(R.id.time_img);//时间图标	
			...
			if (position==0) {
				...
				holder.year.setText(calendar.get(Calendar.YEAR) + "年");
			}else {
				holder.year.setVisibility(View.GONE);
			}
			holder.time.setText(List.get(position).getTitle() + "月份");
			holder.number.setText(List.get(position).getCo() + "");			
			holder.time_img.setBackgroundResource(R.drawable.opport_time_group);
			...
			holder.item.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					...
					intent.putExtra("imsi", List.get(position).getTitle() );
					startActivity(intent);
					finish();
				}
			}); 
