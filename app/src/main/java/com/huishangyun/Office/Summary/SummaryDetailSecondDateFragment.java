...
public class SummaryDetailSecondDateFragment extends Fragment implements MyXListView.MyXListViewListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (secondView == null) {
            secondView = inflater.inflate(R.layout.activity_office_allbusinesstripfragment, container, false);
    ...
    public void onDestroyView() {
        ...
        super.onDestroyView();
        if (null != secondView) {
            ((ViewGroup) secondView.getParent()).removeView(secondView);
        }
    }
     ...
     */
    private void init() {
        no_information = (ImageView) secondView.findViewById(R.id.no_information);
        slistview = (MyXListView) secondView.findViewById(R.id.businesstriplistview);
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            holder.person_img.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Log.e("TAGS","getOFUserName2="+list.get(position).getOFUserName());
                    Log.e("TAGS","getManager_Name2="+list.get(position).getManager_Name());
                }
            });
            return convertView;
        }
