...
public class PreferenceUtils {
	...
	public static String getStringFromShared(Context content,String key, String defaultValue) {
		SharedPreferences sp = content.getSharedPreferences(Content.SPNAME,
