 ...
 *
 */
public class MainClueOrdinaryEntryActivity extends BaseActivity implements
		MyXListViewListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MyApplication.getInstance().showDialog(MainClueOrdinaryEntryActivity.this, true, "Loading...");
		setData(0,0,0);
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				if (position - 1 >= 0) {
					Intent intent = new Intent(
							MainClueOrdinaryEntryActivity.this,
	...
	public class ButtonClickListener implements OnClickListener {
		...
		public void onClick(View v) {
			...
			case R.id.back_mian:// 返回到九宫格
				...
				break;
			case R.id.search:
				Intent intent1 = new Intent(MainClueOrdinaryEntryActivity.this, ClueSearchActivity.class);
				intent1.putExtra("index", 1);
				startActivity(intent1);
				break;
			case R.id.addclue:
				Intent intent2 = new Intent(MainClueOrdinaryEntryActivity.this, NewClueActivity.class);
		...
		public void handleMessage(Message msg) {
			...
			switch (msg.what) {
				case 1:
	               ...
	               MyApplication.getInstance().showDialog(MainClueOrdinaryEntryActivity.this, false, "Loading...");
					break;
				case 2:
					//正在加载界面
					showDialog("正在加载......");
			...
			case 4:
				...
				if (ItemLists.size()<=0) {
					new ClueCustomToast().showToast(MainClueOrdinaryEntryActivity.this,
