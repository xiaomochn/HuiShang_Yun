 ...
 *
 */
public class TopOnlookActivity extends BaseActivity implements MyXListView.MyXListViewListener {
    ...
    private int requestCode = 0x1111;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_office_top_onlook);
		init();
	}
	...
	private void init(){
		...
		MyApplication.getInstance().showDialog(TopOnlookActivity.this, true, "Loading...");
		...
		mlistview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(TopOnlookActivity.this,OnLooksDetails.class);
...
//		取消时：Action=Delete
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(android.os.Message msg) {
			...
			case GET_LIST_SUCCESS:
				...
				MyApplication.getInstance().showDialog(TopOnlookActivity.this, false, "Loading...");
				if (mList.size()<=0) {
	...
	private OnClickListener onClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.more_option://更多
				...
				mIntent = new Intent(TopOnlookActivity.this,CreateOnlookersActivivty.class);
			...
			if (!list.get(position).getTopic().equals("")) { // 判断是否有话题
				...
				spanText.setSpan(new ClickableSpan(){
					...
					public void onClick(View widget) {
						...
						/*Intent intent = new Intent(TopOnlookActivity.this, TopOnlookActivity.class);
	...
	private void showToast(boolean isS,String msg){
		if (isS) {
			 ClueCustomToast.showToast(TopOnlookActivity.this,
