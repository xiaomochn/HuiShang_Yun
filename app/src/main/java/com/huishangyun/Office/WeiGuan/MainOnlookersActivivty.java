 ...
 *
 */
public class MainOnlookersActivivty extends BaseActivity implements MyXListView.MyXListViewListener {
	
	private LinearLayout back;//返回
	private LinearLayout more_option;//更多-弹出
	private MyXListView mlistview;
    private	PopupWindow pw;
    private BaseAdapter adapter;
    private BaseAdapter girdViewAdapter;
    ...
    private static final int GET_LIST_BUG = 0x0003;//返回错误码
    private int requestCode = 0x1111;//请求码
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_office_onlooks_main);
		init();
		PopuWindow();
	}
	 ...
	 */
	private void init(){
		webHelpPraise = new webServiceHelp<>(Methods.SET_ONLOOKS_PRAISE, new TypeToken<ZJResponse<T>>(){}.getType());
		...
		MyApplication.getInstance().showDialog(MainOnlookersActivivty.this, true, "Loading...");
		...
		more_option.setOnClickListener(onClick);
		mlistview.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				Intent intent = new Intent(MainOnlookersActivivty.this,OnLooksDetails.class);
	 ...
	 * 点赞接口回调
	 */
	private webServiceHelp.OnServiceCallBack<T> onLooksPraise = new webServiceHelp.OnServiceCallBack<T>() {
...
//		取消时：Action=Delete
		...
		public void handleMessage(android.os.Message msg) {
			...
			case GET_LIST_SUCCESS:
				if (PagerIndex != 1) {
					...
					//这里不能用mList = cList，否则会导致：adapter.notifyDataSetChanged();无效
					for (int i = 0; i < cList.size(); i++) {
						mList.add(cList.get(i));
					}
				...
				MyApplication.getInstance().showDialog(MainOnlookersActivivty.this, false, "Loading...");
				if (mList.size()<=0) {
	...
	private OnClickListener onClick = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			case R.id.more_option://更多
				pw.showAsDropDown(more_option);
				break;
			case R.id.send_onlooks://发表围观
				mIntent = new Intent(MainOnlookersActivivty.this,CreateOnlookersActivivty.class);
				mIntent.putExtra("Tittle", "发表围观");
				startActivityForResult(mIntent, requestCode);
				pw.dismiss();
				break;
			case R.id.my_onlooks://我的围观
				mIntent = new Intent(MainOnlookersActivivty.this,MyOnlookersActivivty.class);
				startActivity(mIntent);
				pw.dismiss();
				break;
			case R.id.my_comment://我的评论
				mIntent = new Intent(MainOnlookersActivivty.this,MyOnLooksComment.class);
				startActivity(mIntent);
				pw.dismiss();
				break;
			default:
	...
	private void PopuWindow(){
		...
		View pwView = inflater.inflate(R.layout.activity_office_onlooks_popuwindow, null);
		pw = new PopupWindow(pwView);
	   ...
	   //防止弹出菜单获取焦点之后，点击activity的其他组件没有响应
		...
		// 设置弹出窗体的宽
		pw.setWidth(dm.widthPixels / 2);	
		
		// 设置弹出窗体的高
		pw.setHeight(LayoutParams.WRAP_CONTENT);
		
		LinearLayout send_onlooks = (LinearLayout) pwView.findViewById(R.id.send_onlooks);//发表围观
		LinearLayout my_onlooks = (LinearLayout) pwView.findViewById(R.id.my_onlooks);//我的围观
		LinearLayout my_comment = (LinearLayout) pwView.findViewById(R.id.my_comment);//我的评论
		send_onlooks.setOnClickListener(onClick);
		my_onlooks.setOnClickListener(onClick);
		my_comment.setOnClickListener(onClick);
	}
	...
	public class mAdapter extends BaseAdapter{
		...
		public View getView(final int position, View convertView, ViewGroup parent) {
			...
			if (!list.get(position).getTopic().equals("")) { // 判断是否有话题
				...
				spanText.setSpan(new ClickableSpan(){
					...
					public void onClick(View widget) {
						...
						Intent intent = new Intent(MainOnlookersActivivty.this, TopOnlookActivity.class);
			...
			if (indexFile == 0 && indexImg == 1) {
				holder.showLine.setVisibility(View.GONE);
				holder.imageBig.setImageResource(R.drawable.defaultimage02);
				...
				girdViewAdapter = new mGirdViewBaseAdapter(context,allData,indexImg);
	...
	public void onRefresh() {
		...
		handler.postDelayed(new Runnable() {
		 ...
		 L.e("json:" + getListJson(PagerIndex,PagerSize));
	}
	...
	public void onLoadMore() {
        ...
        PagerSize += 5;
     	webHelp.start(getListJson(PagerIndex,5));
     	L.e("json:" + getListJson(PagerIndex,5));
	}
	...
	private void showToast(boolean isS,String msg){
		if (isS) {
			 ClueCustomToast.showToast(MainOnlookersActivivty.this,
