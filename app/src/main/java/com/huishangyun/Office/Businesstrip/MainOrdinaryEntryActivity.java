...
public class MainOrdinaryEntryActivity extends BaseActivity {
	...
	private LinearLayout navigation_bar;//导航条
...
//	private DepartmentBusinessTripFragment fragment3;
	...
	private void init(){
		...
		navigation_bar.setVisibility(View.GONE);//不可见
	...
	private class ButtonClickListener implements View.OnClickListener{
		...
		public void onClick(View v) {
            ...
            case R.id.alltravel://全部出差
            	...
            	alltravel.setTextColor(Color.parseColor("#21a5de"));
			...
			case R.id.mytravel://我的出差
            	...
            	mytravel.setTextColor(Color.parseColor("#21a5de"));
            	departmenttravel.setTextColor(Color.parseColor("#646464"));
				break;
			case R.id.departmenttravel://部门出差
				...
				alltravel.setTextColor(Color.parseColor("#646464"));
            	mytravel.setTextColor(Color.parseColor("#646464"));
            	departmenttravel.setTextColor(Color.parseColor("#21a5de"));
				break;
